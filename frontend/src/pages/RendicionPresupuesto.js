...
const RendicionPresupuesto = () => {
  ...
  const onSubmit = async (ev) => {
    ...
    if (tieneComprobante && archivo && archivo.size > RENDICION_PRESUPUESTO_MAX_FILE_BYTES) {
      toast.error(
          ...
          <div>
            ...
            {!tieneComprobante && (
              <p className="text-xs text-slate-500 mt-2">
                Se generará un PDF tipo recibo (visible en el correo al administrador y descargable aquí).
              </p>
            )}
          </div>
            ...
            <>
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 mt-1">
                  ...
                  Formatos: PDF, imagen (JPG, PNG, GIF) o Word.
                </p>
              </div>
            </>
          )}
