...
CREATE TABLE empleados (
    ...
    es_consultor_cp TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Consultor asignable en Control de proyectos (catálogo)',
...
CREATE TABLE solicitudes_vacaciones (
    ...
    observaciones TEXT,
    estado ENUM('borrador', 'pendiente_jefe', 'pendiente_contadora', 'aprobada', 'rechazada', 'rechazada_definitiva', 'cancelada') DEFAULT 'borrador',
    motivo_apelacion TEXT NULL,
    fecha_apelacion DATETIME NULL,
    apelacion_usada TINYINT(1) NOT NULL DEFAULT 0,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    FOREIGN KEY (empleado_id) REFERENCES empleados(id),
